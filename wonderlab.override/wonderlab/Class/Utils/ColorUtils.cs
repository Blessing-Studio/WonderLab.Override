...
public struct ColorUtils : IEquatable<ColorUtils>
{
    ...
    /// <see cref="ColorUtils.Empty"/> is returned
    /// </summary>
...
#if NETSTANDARD2_0
    private static bool TryParseNetStandard2(ReadOnlySpan<char> value, out ColorUtils ec)
    {
    ...
    /// <summary>
    /// Creates an RGB <see cref="ColorUtils"/> from the specified R,G,B values. The alpha is set to 255
    /// </summary>
    /// <param name="r">Red, [0,255]</param>
    /// <param name="g">Green, [0,255]</param>
    /// <param name="b">Blue, [0,255]</param>
    ...
    /// <summary>
    /// Creates an RGB <see cref="ColorUtils"/> from the specified A,R,G,B values.
    /// </summary>
    /// <param name="a">Alpha, [0,255]</param>
    /// <param name="r">Red, [0,255]</param>
    /// <param name="g">Green, [0,255]</param>
    ...
    /// <summary>
    /// Creates an RGB <see cref="ColorUtils"/> from the specified A,R,G,B float values.
    /// </summary>
    ...
    public static ColorUtils FromRGBf(float r, float g, float b, float a = 1)
    {
        ...
        newColor._c2 = MathUtils.Clamp(g, 0, 1);
        newColor._c3 = MathUtils.Clamp(b, 0, 1);
        newColor._alpha = MathUtils.Clamp(a, 0, 1);
        return newColor;
    }

    /// <summary>
    /// Creates an RGB <see cref="ColorUtils"/> from an unsigned integer
    /// </summary>
    ...
    /// <summary>
    /// Creates an HSV <see cref="ColorUtils"/> from the given values
    /// </summary>
    ...
    /// <summary>
    /// Creates an HSV <see cref="ColorUtils"/> from the given float values
    /// </summary>
    /// <param name="hue">Hue, [0,360)</param>
    ...
    public static ColorUtils FromHSVf(float hue, float sat, float val, float alpha = 1)
    {
        ...
        newColor._c2 = MathUtils.Clamp(sat, 0, 1);
        newColor._c3 = MathUtils.Clamp(val, 0, 1);
        newColor._alpha = MathUtils.Clamp(alpha, 0, 1);
        return newColor;
    }

    /// <summary>
    /// Creates an HSL <see cref="ColorUtils"/> from the given values
    /// </summary>
    /// <param name="hue">Hue, [0,360)</param>
    /// <param name="sat">Saturation, [0,100]</param>
    ...
    /// <summary>
    /// Creates an HSL <see cref="ColorUtils"/> from the given float values
    /// </summary>
    /// <param name="hue">Hue, [0,360)</param>
    /// <param name="sat">Saturation, [0,1]</param>
    ...
    public static ColorUtils FromHSLf(float hue, float sat, float light, float alpha = 1)
    {
        ...
        newColor._c1 = hue == -1 ? 0 : MathUtils.Clamp(hue % 360, 0, 360);
        newColor._c2 = MathUtils.Clamp(sat, 0, 1);
        newColor._c3 = MathUtils.Clamp(light, 0, 1);
        newColor._alpha = MathUtils.Clamp(alpha, 0, 1);
        return newColor;
    }

    /// <summary>
    /// Creates a CMYK <see cref="ColorUtils"/> from the given values
    /// </summary>
    ...
    /// <summary>
    /// Creates a CMYK <see cref="ColorUtils"/> from the given float values
    /// </summary>
    ...
    public static ColorUtils FromCMYKf(float c, float m, float y, float k, float alpha = 1)
    {
        ...
        newColor._c2 = MathUtils.Clamp(m, 0, 1);
        newColor._c3 = MathUtils.Clamp(y, 0, 1);
        newColor._c4 = MathUtils.Clamp(k, 0, 1);
        newColor._alpha = MathUtils.Clamp(alpha, 0, 1);
        return newColor;
    }
